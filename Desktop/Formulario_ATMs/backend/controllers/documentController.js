...
// Límite de caja por tipo de imagen. Se mantiene la proporción original.
const imageBoxes = {
    fotoups: [150, 200],
...
const generarInforme = async (req, res) => {
    try {
        ...
        const ImageOpts = {
            ...
            getSize: (img, tagValue, tagName) => {
                try {
                    ...
                    // Mantiene proporción y evita agrandar imágenes pequeñas.
        ...
        doc.render({
            ...
            marca_ups: req.body.marca_ups,
            modelo_ups: req.body.modelo_ups,
            ...
            firma_elaborador: req.savedImages?.firma_elaborador || '',
            ...
            num_serie_tarjetared: req.body.num_serie_tarjetared,
            num_mac_tarjetared: req.body.num_mac_tarjetared,
            //descripciones y fotos de condiciones iniciales
            ...
            //descripciones y fotos de desconexion y retiro
            ...
            //descripciones y fotos de instalacion y conexion
            ...
            //descripciones y fotos de tension de entrada
            ...
            //descripciones y fotos de tension de salida
            ...
            //decripciones y fotos de tension de salida ups
            ...
            //descripciones y fotos de tensiones de ups display, cargas y bateria
            ...
            //descripciones y fotos de temperatura, busdc y carga
            ...
            //descripciones y fotos de observaciones y recomendaciones
        ...
        const tituloInforme = (req.body.nombre_actividad || 'Sin_titulo').replace(/\s+/g, '_').replace(/[^\w\-_áéíóúñüÁÉÍÓÚÑÜ]/g, '');
        const fechaInforme = (req.body.fecha_elaboracion || '').replace(/-/g, '-');
        const nombreArchivo = `${tituloInforme}_${fechaInforme}.docx`;
